...
public class Activity6 {
	 ...
	 
	 {
		 ...
		 wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy.AndroidUIAutomator("text(\"Lazy Loading\")")));
		// Count the number of images shown on the screen
	        ...
	        driver.findElement(MobileBy.AndroidUIAutomator("UiScrollable(UiSelector()).scrollForward().scrollTextIntoView(\"chris\")"));

	        driver.findElement(MobileBy.AndroidUIAutomator("UiScrollable(UiSelector()).scrollForward().scrollTextIntoView(\"helen\")"));
