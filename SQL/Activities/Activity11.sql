...
select a.customer_name,a.customer_id from customers a where 1<(select count(*) from orders b where a.customer_id = b.customer_id) 
Union  
select a.salesman_name,a.salesman_id from salesman a where 1<(select count(*) from orders b where a.salesman_id = b.salesman_id);
